...
public class home_latest extends generic{
	@Test
    public void test3() throws InterruptedException
    {
        ...
        //order page 
        driver.findElement(By.id("inputFirstName")).sendKeys("Dhammakka");
        Thread.sleep(2000);
        driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys("Pandav");
        Thread.sleep(2000);
        driver.findElement(By.id("inputEmail")).sendKeys("pandavdhammakka@gmail.com");
        driver.findElement(By.id("inputPassword")).sendKeys("Dhm@123");
        driver.findElement(By.xpath("//input[@type='number']")).sendKeys("8217399539");
        driver.findElement(By.id(" address1")).sendKeys("chikodi");
        driver.findElement(By.id("address2")).sendKeys("Belgaum");
